...
public class Controller {
	...
	public static void main(String[] args) {
		...
		try {
			Wallet wallet = walletService.registerWallet(new Wallet(1, "Ford", 5000.0, "123"));
			...
			Wallet wallet2 = walletService.registerWallet(new Wallet(2, "Ford 2", 3000.0, "123"));
			System.out.println("Wallet 2:" + wallet2);
			if (walletService.fundTransfer(1, 2, 1050.0)== true )
				System.out.println("Fund transfer successful.");
			System.out.println("W1:" + wallet);
			System.out.println("W2:" + wallet2);
			walletService.fundTransfer(1, 2, 700.0);
			System.out.println("W1:" + wallet);
			System.out.println("W2:" + wallet2);
			...
			walletService.addFundsToWallet(2,3000.0);
			System.out.println("Wallet id 1, balance=" + walletService.showWalletBalance(1));
